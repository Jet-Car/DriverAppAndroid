...
public class UploadDocActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_FILE_REQUEST_CODE && resultCode == RESULT_OK/* && data != null*/) {
            ...
            Utils.printLog("filePath", "::" + file.getName());
            if (file.exists()) {
                ...
                Utils.printLog("filePath data", "::" + data.getData());

                  /*"selectedImageUri=null issue faced in 1 app" Related Changes */
            ...
            if (filePath != null) {
                ...
                Utils.printLog("filePath", "::" + Utils.getFileExt(filePath));
