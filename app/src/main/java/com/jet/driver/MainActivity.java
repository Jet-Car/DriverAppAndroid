...
//        app_type = generalFunc.getJsonValue("APP_TYPE", userProfileJson);
        ...
        //btn_edit = ((MaterialRippleLayout) findViewById(R.id.btn_edit)).getChildView();
...
//                new RadiusDialog().run();
    ...
    class RadiusDialog implements Runnable {

        @Override
        public void run() {
            // TODO Auto-generated method stub

            final Dialog dialog_radius = new Dialog(getActContext(), R.style.ImageSourceDialogStyle);

            MTextView radiusSetTxtView;
            MaterialEditText radiusBox;
            LinearLayout radiusarea;

            dialog_radius.setContentView(R.layout.set_radius_view);

            radiusSetTxtView = (MTextView) dialog_radius.findViewById(R.id.radiusSetTxtView);
            radiusBox = (MaterialEditText) dialog_radius.findViewById(R.id.radiusBox);
            radiusBox.setBothText("", generalFunc.retrieveLangLBl("Enter Radius Value", "LBL_ENTER_RADIUS_HINT"));
            radiusSetTxtView.setText(generalFunc.retrieveLangLBl("SET", "LBL_SET"));
            radiusBox.setInputType(InputType.TYPE_CLASS_NUMBER);
            radiusSetTxtView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
            ...
            dialog_radius.setCanceledOnTouchOutside(true);

            Window window = dialog_radius.getWindow();
            window.setGravity(Gravity.BOTTOM);

            window.setLayout(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);

            dialog_radius.getWindow().setLayout(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
            dialog_radius.setCancelable(true);
    ...
    public void showRadiusBox() {
        ...
        input.setBothText("", generalFunc.retrieveLangLBl("", "LBL_ENTER_RADIUS_HINT"));
