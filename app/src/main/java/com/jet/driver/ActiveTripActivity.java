...
import com.general.files.OpenPassengerArrayDialouge;
...
public class ActiveTripActivity extends AppCompatActivity implements OnMapReadyCallback, GetLocationUpdates.LocationUpdates {
    ...
    public void unRegisterReceivergcm() {
        if (gcmBroadCastReceiver != null) {
            try {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String trip_detail=getIntent().getStringExtra("tripDetailArray");
        try {
            last_data_trip= new  JSONArray(trip_detail);
            ...
            public void setResponse(String responseString) {
                ...
                if (responseString != null && !responseString.equals("")) {
                    ...
                    if (status.equals("OK")) {
                        ...
                        // Notify cubejek that Route is not drawn.
                        killRouteDrawn = true;
        ...
        switch (item.getItemId()) {
            case R.id.menu_passenger_detail:
                ...
                if (REQUEST_TYPE.equals("Deliver")) {
                    ...
                    if (OpenMainProfile.isPool==0){
                        new OpenPassengerDetailDialog(getActContext(), data_trip, generalFunc, false);
                    }else {
                        new OpenPassengerArrayDialouge(getActContext(), last_data_trip, generalFunc, false);
                    }
...
//                    generalFunc.retrieveLangLBl("Total toll price", "LBL_TOLL_PRICE_TOTAL") + ": " + tollcurrancy + " " + tollamount);
    ...
    public void countDownStart() {
        Utils.printLog("Countdownstart", "::called");
        if (timerrequesttask != null) {
            timerrequesttask.stopRepeatingTask();
            timerrequesttask = null;
        }
