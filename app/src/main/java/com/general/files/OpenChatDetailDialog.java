...
public class OpenChatDetailDialog {
    ...
    public void show() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("cubejek-app");
        ...
        DatabaseReference mainRef = FirebaseDatabase.getInstance().getReference("cubejek-app");
