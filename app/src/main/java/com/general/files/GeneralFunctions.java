...
import com.jet.driver.ContactUsActivity;
import com.jet.driver.LauncherActivity;
import com.jet.driver.MyWalletActivity;
import com.jet.driver.R;
import com.jet.driver.VerifyInfoActivity;
...
//            e.printStackTrace();
    ...
    public JSONArray getJsonArray(String key, JSONObject obj) {
        try {
            JSONArray obj_temp = obj.getJSONArray(key);
